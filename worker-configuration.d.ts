/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 07b1a5a84c86f6eb1cea207bcd0ebd59)
// Runtime types generated with workerd@1.20260317.1 2025-03-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GoogleDocsMcp" | "MissiveMcp";
	}
	interface Env {
		FIRECRAWL_API_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").GoogleDocsMcp>;
		MISSIVE_OBJECT: DurableObjectNamespace<import("./src/index").MissiveMcp>;
	}
}
